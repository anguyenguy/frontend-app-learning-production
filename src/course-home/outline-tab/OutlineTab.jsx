...
function OutlineTab({ intl }) {
  ...
  return (
    <>
      ...
      <div className="tab--item view-course-course" id="view-course-course">
        ...
        <div className="tab--item-inner d-flex">
          <div className="tab--item-left">
            <div className="tab--item-title d-flex justify-content-between">
              <h1>{title}</h1>
          ...
          <div className="course-tab-right">
            <ProctoringInfoPanel />
