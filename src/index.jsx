...
import { messages as footerMessages } from '@anguyenguy/frontend-component-footer';
import { messages as headerMessages } from '@anguyenguy/frontend-component-header';
...
import BookmarksTab from './course-home/bookmarks-tab/BookmarksTab';
        ...
        <NoticesProvider>
          <UserMessagesProvider>
            <Switch>
              ...
              <PageRoute path="/course/:courseId/bookmarks">
                <TabContainer tab="outline" fetch={fetchOutlineTab} slice="courseHome">
                  <BookmarksTab />
                </TabContainer>
              </PageRoute>
              <PageRoute path="/course/:courseId/updates">
                <TabContainer tab="outline" fetch={fetchOutlineTab} slice="courseHome">
                  <UpdatesTab />
                </TabContainer>
              </PageRoute>
